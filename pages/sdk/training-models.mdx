...
This enables you to create avatars/headshots of real people, original art/styles, or even professional photography of products.

import { Callout } from 'nextra/components'

<Callout type="info" emoji="ℹ️">
  We provide a high-level API for training image models, but If you're interested in further customization or deploying your own custom pipelines/models, we encourage you to check out [our partner Banana](https://www.banana.dev/?ref=leap-docs).
</Callout>
